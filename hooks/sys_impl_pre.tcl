...
################################################################################
##
##  File Name      : sys_impl_pre.tcl
##  Initial Author : Andreas Braun <andreas.braun@missinglinkelectronics.com>
##
################################################################################
##
##  File Summary   : Pre implementation build system internal hook
##
################################################################################
...
puts "Start hook script 'sys_impl_pre' ..."
...
# Update result base timestamp if build starts with implementation step to
...
puts "Hook script 'sys_impl_pre' done."
