...
proc ::vbs::bd_util::export_single_hier {dir hier gen_wrapper dict_exclude \
	...
	if {[info exists fp_tcl]} {
		# Add auto-generated code statement
		puts $fp_tcl "# ------------------------------------------------------------------------------"
		puts $fp_tcl "# This file was auto-generated by vbs_bd_util.tcl"
		puts $fp_tcl "# Do not modify this file directly, as changes may be overwritten."
		puts $fp_tcl "# ------------------------------------------------------------------------------\n"
	...
	if {[info exists fp_dict]} {
		# Add auto-generated code statement
		puts $fp_dict "# ------------------------------------------------------------------------------"
		puts $fp_dict "# This file was auto-generated by vbs_bd_util.tcl"
		puts $fp_dict "# Do not modify this file directly, as changes may be overwritten."
		puts $fp_dict "# ------------------------------------------------------------------------------\n"
